...
public class Practica5eje4 {
    ...
    public static void main(String[] args) {
        ...
        Corista c1=new Corista(1, "Miguel", "35678654", 35);
        Corista c2=new Corista(2, "Maria", "35680654", 38);
        
        Director d1=new Director(3, "Juan", "44567876", 58);
        
        CoroSemicircular cs1=new CoroSemicircular(d1, 5);
        
        cs1.agregarUnCorista(c2);
        cs1.agregarUnCorista(c1);
        
        System.out.println(cs1.toString());
        
        CoroHileras ch1=new CoroHileras(d1, 6, 3);
        
        ch1.agregarUnCorista(c2);
        ch1.agregarUnCorista(c1);
        
        System.out.println(cs1.estaBienFormado());
        System.out.println(ch1.estaLleno());
        System.out.println(ch1.estaBienFormado());
