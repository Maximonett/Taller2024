...
public class ServicioMeteorologico {
    ...
    public static void main(String[] args) {
        ...
        Estacion e1=new Estacion("La Plata", "34°56′00″S", "57°57′00″O", 2020, 5);
        
        
        
        System.out.println(e1.obtenerTemperatura(2, 2021));
        System.out.println(e1.mayorTemperatura());
        
        System.out.println(e1.promedioPorAños());
        System.out.println(e1.promedioPorMeses());
    }
